...
let BUSINESS_SHEET_ID: string | null =
  "1BGCOC4T8ymbiN_HGuM7AOjaXGkE8yyxYKxoRpWvkzYE";
...
const BUSINESS_HEADERS = [
  ...
  "Avg Margin per Product (₹)",
  "Avg Monthly Sales (₹)",
  "Sales Channels",
  "Online Channels",
  "Online Channels (Other)",
  "Offline Channels",
  "Offline Channels (Other)",
  "Uses ERP/CRM",
  "ERP/CRM Name",
  "Interested in ERP/CRM",
