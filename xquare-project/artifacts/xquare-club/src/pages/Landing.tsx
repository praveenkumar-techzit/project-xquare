  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-primary/30">
          ...
          <div className="max-w-4xl">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-8">
                Collaboration should not be expensive.
                <br />
            ...
            >
              XQUARE CLUB is a community-driven platform where small businesses
              and growing influencers can connect, collaborate, and grow
              together.
            </motion.p>
            ...
            >
              Built to make promotions more accessible and opportunities more
              open.
            </motion.p>
            ...
            >
              ...
              <p className="mt-6 text-sm text-white/50 flex items-center gap-2">
                ...
                />
                <span>
                  {"Applications to Early Access are "}
                  <span
                    onClick={scrollToDisclaimer}
                    className="underline decoration-white/50 hover:decoration-white transition-colors cursor-pointer"
                  >
                    {"free*"}
                  </span>
                  {". Influencers and sellers can apply now."}
                </span>
              </p>
            </motion.div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6 text-lg">
              <p>
                XQUARE CLUB is a platform built to bring businesses,
                influencers, and customers into one connected ecosystem.
              </p>
              <p>
                It enables businesses to showcase their products, gives
                influencers the opportunity to promote products in a more
                accessible way, and helps customers discover products through
                people and content they relate to.
              </p>
              <p className="font-semibold text-white/90 border-l-2 border-primary pl-4 py-1">
                More than just a platform, XQUARE CLUB is an initiative built
                around community, shared growth, and multiplied opportunity.
              </p>
            </div>
            ...
            <div className="aspect-square rounded-full bg-gradient-to-tr from-navy to-black border border-white/5 shadow-2xl flex items-center justify-center p-12 relative">
              ...
              <div className="text-center z-10">
                ...
                <p className="text-base text-white/70 mb-4">
                  <strong className="text-primary">CLUB</strong> stands for
                  community — a space where people support one another, grow
                  together, and create value through connection.
                </p>
                <p className="text-base text-white/70 mb-4">
                  <strong className="text-primary">XQUARE</strong> represents
                  multiplication — the belief that when the right people come
                  together in the right ecosystem, opportunities do not just
                  increase, they multiply.
                </p>
                <p className="text-base text-white font-medium mt-6">
                  Together, it represents a community where participation
                  multiplies value.
                </p>
              </div>
            </div>
      ...
      <Section darker>
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl mb-6">
            Built to solve real gaps in today's ecosystem
          </h2>
          <p className="text-xl text-white/70">
            Today, many influencers struggle to get brand opportunities unless
            they already have very high follower counts. At the same time, many
            small and growing businesses find influencer collaborations
            expensive, difficult to access, or hard to manage.
          </p>
        </div>
      ...
      <Section id="how-it-works">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl mb-6">
            A connected model built for shared growth
          </h2>
          <p className="text-xl text-white/70">
            XQUARE CLUB brings together three important parts of the ecosystem
            in one place.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "Businesses can list their products, build visibility, and explore influencer-led promotion in a more practical and budget-friendly way.",
            },
            {
              label: "For Influencers",
              text: "Influencers can create their presence on the platform, discover products they can promote, and benefit from the activity generated through their promotions.",
            },
            {
              label: "For Customers",
              text: "Customers can discover products through creators, recommendations, and content that feels more engaging and relatable.",
            },
          ].map((card, i) => (
            <motion.div
              key={i}
              whileHover={{
                y: -5,
                boxShadow: "0 0 35px -5px rgba(59,130,246,0.45)",
              }}
        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/70 mb-8">
                On most traditional social platforms, collaboration
                opportunities often go only to creators with large follower
                numbers. XQUARE CLUB aims to make opportunities more accessible.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-white/70 mb-8">
                For many MSMEs and growing businesses, influencer marketing can
                feel expensive and out of reach.
              </p>
              <ul className="space-y-4">
                {[
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/70 mb-8">
                Customers benefit from a more trust-based and engaging product
      ...
      <Section>
        <div className="grid md:grid-cols-3 gap-12">
          <div className="md:col-span-3 text-center max-w-4xl mx-auto mb-12">
            <h2 className="text-4xl font-display mb-6">
              The impact XQUARE CLUB aims to create
            </h2>
            <p className="text-xl text-white/80">
              XQUARE CLUB is being built on the belief that growth should not
              belong only to the already-established. By bringing businesses and
              influencers into one ecosystem, XQUARE CLUB aims to create a
              multiplying effect — where one opportunity can lead to many more.
            </p>
          </div>
          ...
          <div className="bg-card/50 border border-card-border p-8 rounded-3xl backdrop-blur-sm hover:bg-card/80 transition-colors">
            ...
            <p className="text-lg">
              For small businesses that need practical and affordable visibility
            </p>
          </div>
          ...
          <div className="bg-card/50 border border-card-border p-8 rounded-3xl backdrop-blur-sm hover:bg-card/80 transition-colors">
            ...
            <p className="text-lg">
              For influencers who deserve opportunities even before reaching
              massive numbers
            </p>
          </div>
          ...
          <div className="bg-card/50 border border-card-border p-8 rounded-3xl backdrop-blur-sm hover:bg-card/80 transition-colors">
            ...
            <p className="text-lg">
              For communities that become stronger when people help one another
              grow
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-16">
          <div className="bg-gradient-to-br from-navy to-black border border-white/10 p-10 rounded-3xl">
            <h3 className="text-2xl font-display text-primary mb-4 uppercase tracking-widest text-sm">
              Our Mission
            </h3>
            <p className="text-xl mb-6">
              To build a community-driven platform where businesses and
              influencers can connect, collaborate, and grow in a way that is
              more inclusive, accessible, and rewarding.
            </p>
            <p className="text-white/60">
              XQUARE CLUB exists to make opportunities more reachable and growth
              more possible for a wider group of people.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-bl from-navy to-black border border-white/10 p-10 rounded-3xl">
            ...
            <p className="text-xl mb-6">
              To create a trusted ecosystem where community participation leads
              to multiplied value.
            </p>
            <p className="text-white/60 mb-4">
              XQUARE CLUB envisions a future where businesses gain stronger
              reach, influencers gain fairer opportunities, and every meaningful
              collaboration contributes to greater growth and impact.
            </p>
            <p className="text-white/90 font-medium italic border-l-2 border-primary/50 pl-4 py-1">
              "At the heart of this vision is a simple belief: when people grow
              together, outcomes multiply."
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section id="register" darker className="border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl mb-6">
              Be among the first to join XQUARE CLUB
            </h2>
            <p className="text-xl text-white/70 mb-3">
              We are currently inviting influencers and businesses to apply for
              early access to XQUARE CLUB.
            </p>
            <p className="text-base text-white/50">
              If you are looking to grow through collaboration, visibility, and
              new opportunities, this is your chance to get in early.{" "}
              <button
                onClick={scrollToDisclaimer}
                className="text-white/70 font-medium underline decoration-white/50 hover:decoration-white transition-colors cursor-pointer"
              >
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            ...
            <div className="bg-card border border-card-border rounded-2xl p-8 flex flex-col relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-primary/15 border border-primary/25 flex items-center justify-center text-xl">
                  🎬
                </div>
                <h3 className="text-2xl font-bold">For Influencers</h3>
              </div>
              <p className="text-white/60 text-sm leading-relaxed mb-8 flex-1">
                Apply through our influencer onboarding form and let us know
                your interest in joining XQUARE CLUB as a creator.
              </p>
              <div className="mt-auto">
                ...
                <p className="text-white/30 text-xs text-center">
                  ...
                  <button
                    onClick={scrollToDisclaimer}
                    className="underline decoration-white/30 hover:decoration-white/60 transition-colors cursor-pointer"
                  >
                    Free to apply*
                  </button>
                </p>
            ...
            <div className="bg-card border border-card-border rounded-2xl p-8 flex flex-col relative overflow-hidden">
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-8 flex-1">
                Apply through our seller onboarding form to express your
                interest in listing your business on XQUARE CLUB.
              </p>
              <div className="mt-auto">
                <motion.button
                  whileHover={{ y: -2 }}
          ...
          <p className="text-center text-white/50 text-sm">
            No payment. No commitment. Just an early step into something built
            for growth.
          </p>
        </div>
      </Section>
      ...
      <Section className="text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-white/80 mb-6 leading-relaxed">
            XQUARE CLUB is more than a platform name — it reflects a vision of
            people, businesses, and opportunities coming together to create
            greater value for one another.
          </p>
          <p className="text-lg text-white/60 mb-12">
            If you are an influencer looking to grow, or a business looking for
            smarter promotion opportunities, now is the time to step in early.
          </p>
          ...
          <div className="inline-block border border-white/10 rounded-full px-8 py-4 bg-white/5 backdrop-blur-md">
            <p className="font-display text-xl md:text-2xl font-bold tracking-wide">
              Join early. <span className="text-primary">Grow together.</span>{" "}
      ...
      <div id="disclaimer" className="relative z-20 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <p className="text-white/50 text-sm max-w-3xl">
            *Application submission is currently free for both influencers and
            sellers. Every application will be reviewed and verified manually by
            the XQUARE CLUB team before onboarding. Platform onboarding or
            listing may be subject to charges at a later stage, based on the
            final approval and commercial process.
          </p>
        </div>
      </div>
      ...
      <footer
        id="contact"
        className="border-t border-white/10 bg-black pt-16 pb-8 text-center md:text-left relative z-20"
      >
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm max-w-sm mx-auto md:mx-0">
              A community-driven platform connecting small businesses and
              growing influencers.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-5 text-sm">
            ...
            <p className="text-white/30 text-center md:text-left">
              &copy; {new Date().getFullYear()} XQUARE CLUB. All rights
              reserved.
            </p>

            {/* Policy Links */}
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-3 gap-y-2 text-white/50">
              <a
                href="/privacy-policy"
                className="hover:text-white transition-colors"
              >
